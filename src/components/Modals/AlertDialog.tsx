        ...
        >
            ...
            >
                ...
                <div className="flex justify-center space-x-4">
                    {onCancel && (
                        <button
                            className="text-black text-gray-700 dark:bg-slate-100 px-4 py-2 rounded hover:bg-gray-400"
                            onClick={onCancel}
                        >
                            {cancelText}
                        </button>
                    ...
                    <button
                        className="bg-blue-500 text-white dark:bg-primary px-4 py-2 rounded hover:bg-blue-600"
                        onClick={onConfirm}
                    >
                        {confirmText}
                    </button>
