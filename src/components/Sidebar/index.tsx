...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-dark-custom-300 duration-300 ease-linear dark:bg-dark-custom-700 lg:static lg:translate-x-0 ${
        ...
        >
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <NavLink to="/">
                    <div className="text-title-xl ml-4 w-full flex gap-3">
                        <svg
                            width="68"
                            height="49"
                            viewBox="0 0 88 69"
                        ...
                        >
                            <path
                                d="M0 17C0 7.61116 7.61116 0 17 0H71C80.3888 0 88 7.61116 88 17V52C88 61.3888 80.3888 69 71 69H17C7.61116 69 0 61.3888 0 52V17Z"
                                fill="#000365"
                            />
                            <path
                                d="M19.8271 24.6719H32.1611V27.9971H28.001V42.6895H32.1611V46H19.8271V42.6895H23.8848V27.9971H19.8271V24.6719Z"
                                fill="#FFEE00"
                            />
                            <path
                                d="M41.917 46L35.4717 24.6719H40.0127L43.6309 38.6025L43.9971 40.0381L44.3926 38.5879L48.0254 24.6719H52.5664L46.1064 46H41.917Z"
                                fill="#FFEE00"
                            />
                            <path
                                d="M54.8662 46V24.6719H60.3887C61.375 24.6719 62.2979 24.7939 63.1572 25.0381C64.0166 25.2725 64.7979 25.6094 65.501 26.0488C66.1162 26.4102 66.6631 26.8545 67.1416 27.3818C67.6299 27.8994 68.0547 28.4658 68.416 29.0811C68.8359 29.833 69.1582 30.6631 69.3828 31.5713C69.6172 32.4795 69.7344 33.4463 69.7344 34.4717V36.2295C69.7344 37.2158 69.627 38.1484 69.4121 39.0273C69.1973 39.9062 68.8945 40.7119 68.5039 41.4443C68.1328 42.0986 67.6982 42.7041 67.2002 43.2607C66.7021 43.8076 66.1553 44.2666 65.5596 44.6377C64.8662 45.0771 64.0996 45.4141 63.2598 45.6484C62.4297 45.8828 61.541 46 60.5938 46H54.8662ZM59.0117 28.0117V42.6895H60.5938C61.1016 42.6895 61.5752 42.626 62.0146 42.499C62.4541 42.3721 62.8545 42.1865 63.2158 41.9424C63.5869 41.6885 63.9189 41.3662 64.2119 40.9756C64.5146 40.5752 64.7734 40.1113 64.9883 39.584C65.1641 39.125 65.2959 38.6172 65.3838 38.0605C65.4814 37.4941 65.5303 36.8838 65.5303 36.2295V34.4424C65.5303 33.8271 65.4814 33.2461 65.3838 32.6992C65.2959 32.1426 65.1641 31.6348 64.9883 31.1758C64.7734 30.6289 64.4902 30.1406 64.1387 29.7109C63.7969 29.2812 63.3965 28.9297 62.9375 28.6562C62.5859 28.4512 62.1953 28.2949 61.7656 28.1875C61.3457 28.0703 60.8867 28.0117 60.3887 28.0117H59.0117Z"
                                fill="#FFEE00"
                            />
                        </svg>
